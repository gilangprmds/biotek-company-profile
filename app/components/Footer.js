export default function Footer() {
    return (
      <footer className="bg-primary-dark-2 text-white">
        <div className="container py-20 lg:py-[100px]">
          <div className="row">
            <div className="col-12 order-first lg:col-4">
              <div className="w-full">
                <a href="/" className="inline-block mb-5">
                  ...
                  >
                    {/* Semua style attribute diubah ke format React */}
                    <path
                    ...
                    />
                    <path
                      d="M137.42,29.77h14.69V88.34H137.42V82.15A29,29,0,0,1,128.79,88a24.19,24.19,0,0,1-9.38,1.8q-11.34,0-19.63-8.8T91.5,59.16q0-13.56,8-22.23A25.53,25.53,0,0,1,119,28.27a24.69,24.69,0,0,1,9.89,2,27.17,27.17,0,0,1,8.55,6ZM122,41.83a14.87,14.87,0,0,0-11.32,4.82A17.37,17.37,0,0,0,106.15,59a17.54,17.54,0,0,0,4.58,12.49A14.85,14.85,0,0,0,122,76.39a15.12,15.12,0,0,0,11.48-4.82q4.56-4.81,4.56-12.62q0-7.65-4.56-12.38A15.3,15.3,0,0,0,122,41.83Z"
                      style={{ fill: '#eeeef0' }}
                    />
                    <rect
                      y="29.77"
            ...
            <div className="col-6 lg:col-2">
              <div className="w-full">
                <h4 className="mb-9 text-lg font-semibold text-inherit">Solutions</h4>
                <ul>
                  <li>
                    <a
                      href="#"
            ...
            <div className="col-6 lg:col-2">
              <div className="w-full">
                <h4 className="mb-9 text-lg font-semibold text-inherit">Support</h4>
                <ul>
                  <li>
                    <a
                      href="#"
            ...
            <div className="col-12 -order-3 lg:col-4 lg:order-1">
              <div className="w-full">
                <h4 className="mb-9 text-lg font-semibold text-inherit">Subscribe</h4>
  
                <p className="text-body-dark-11">
                  Subscribe to our newsletter for the latest updates
                </p>
  
                <form action="#" method="POST" className="mt-8 flex">
                  <input
                    type="email"
                    name="email"
                  ...
                  <button
                    type="submit"
                    className="inline-block py-3 w-[50px] rounded-md rounded-s-none text-center text-lg leading-none bg-primary text-primary-color hover:bg-primary-light-10 dark:hover:bg-primary-dark-10 focus:bg-primary-light-10 dark:focus:bg-primary-dark-10"
                  >
        ...
        <div className="w-full border-t border-solid border-alpha-dark"></div>
