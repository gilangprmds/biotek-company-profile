    ...
    <section id="clients" className="section-area py-20">
      ...
      <div className="container mx-auto px-4">
        ...
        {clients.map((client, index) => (
          <div
          className="cursor-pointer shadow-xl hover:scale-105 transition px-1 w-[150px] h-[150px] justify-self-center rounded-2xl mb-6 flex items-center justify-center text-[37px]/none bg-white text-primary-color
